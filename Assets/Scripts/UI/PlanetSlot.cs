...
public class PlanetSlot : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    int ammoniaIncrement = 0; // incrementer for planet names
    int methaneIncrement = 0; // incrementer for planet names
    int germaniumIncrement = 0; // incrementer for planet names
    int acetyleneIncrement = 0; // incrementer for planet names
    ...
    void Update()
    {
        ...
        if (go == null && Input.GetMouseButtonUp(0) && this.GetComponent<Button>().interactable && mouseHover)
        {
            ...
            if (this.name == "Ammonia")
            {
                ...
                // increment planet name
                ammoniaIncrement++;
                go.name = "Ammonia " + ammoniaIncrement;
                // Make planet a child object of the Sun
                go.transform.parent = sun.transform;
                // Add planet to array of planets
                gc.planets.Add(go);
            ...
            if (this.name == "Methane")
            {
                ...
                // increment planet name
                methaneIncrement++;
                go.name = "Methane " + methaneIncrement;
                // Make planet a child object of the Sun
                go.transform.parent = sun.transform;
                // Add planet to array of planets
                gc.planets.Add(go);
            ...
            if (this.name == "Germanium")
            {
                ...
                // increment planet name
                germaniumIncrement++;
                go.name = "Germanium " + germaniumIncrement;
                // Make planet a child object of the Sun
                go.transform.parent = sun.transform;
                // Add planet to array of planets
                gc.planets.Add(go);
            ...
            if (this.name == "Acetylene")
            {
                ...
                // increment planet name
                acetyleneIncrement++;
                go.name = "Acetylene " + acetyleneIncrement;
                // Make planet a child object of the Sun
                go.transform.parent = sun.transform;
                // Add planet to array of planets
                gc.planets.Add(go);
