					...
					if (planet1 != null && planet2 != null)
					{
						...
						if (!linkedAlready)
						{
							...
							if (fail)
							{
								...
								l.UpdateLogLinkFail (firstPlanetScript.planetname,secondPlanetScript.planetname);
							...
							else
							{
								...
								l.UpdateLogLinkSuccessful (firstPlanetScript.planetname,secondPlanetScript.planetname);
...
//        }
    ...
    public void Simulate()
    {
        ...
        if (attacking)
        {
            if (planet1 != null && planet2 != null)
            {
				l.UpdateLogAttack (planet1.GetComponent<Planet>().planetname, planet2.GetComponent<Planet>().planetname);
